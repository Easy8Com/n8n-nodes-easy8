...
const CommonTimeEntryOptions: INodeProperties[] = [
  ...
  },
  {
    ...
    default: '',
    description:
      'ID of the project associated with the time entry. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    typeOptions: {
